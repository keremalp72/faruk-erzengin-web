...
const ContactPage = () => {
  ...
  const mapUrls = {
    europe:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3008.310033271813!2d28.9987561!3d41.0668514!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab6ff5a721ba3%3A0x8faba56dc9dc919a!2zTWVjaWRpeWVrw7Z5IE1haGFsbGVzaSwgQsO8ecO8a2RlcmUgQ2QuIE5vOjc1LCAzNDM4MSDFnmnFn2xpL8Swc3RhbmJ1bCwgVMO8cmtpeWU!5e0!3m2!1str!2str!4v1735985371235!5m2!1str!2str",
    ...
    <div className="contact-page">
      ...
      <div className={`success-overlay ${showSuccess ? "active" : ""}`}>
        <div className="success-modal">
          ...
          <p>
            Teşekkürler, kaydınız başarıyla oluşturuldu.
            <br />
      ...
      <div className="contact-container">
        ...
        <div className="contact-info-grid">
          ...
          >
            ...
            <div className="location-details">
              ...
              <div className="phone-list">
                ...
                <a href="tel:+905322416838">
                  <FaPhone /> +90 532 241 68 38
                </a>
              </div>
            </div>
          </ScrollReveal>
          ...
          >
            ...
            <div className="location-details">
              <p>
                <strong>Adres:</strong> Bağdat Cad. No: 182, Selami Çeşme,
                Kadıköy / İstanbul
              </p>
              <p>
              ...
              <div className="phone-list">
                ...
                <a href="tel:+905374235124">
                  <FaPhone /> +90 537 423 51 24
                </a>
              </div>
            </div>
          </ScrollReveal>
          ...
          >
            ...
            <p>
              Tüm randevu ve sorularınız için ortak hattımızdan bize
              ulaşabilirsiniz.
            </p>
            <div className="contact-links-wrapper">
              <a
                href="tel:+905324535179"
                className="contact-link-item main-hotline"
              >
                <FaPhone className="c-link-icon" />
                <div className="link-text">
                  <strong>Ortak Hat:</strong>
                  <span>+90 532 453 51 79</span>
                </div>
              </a>
              <a
                href="mailto:farukerzengin@gmail.com"
          ...
          >
            ...
            <div className="social-connect-box">
              ...
              <div className="social-icons-row">
                <a
                  href="https://www.facebook.com/faruk.erzengin.2025/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/farukerzengin/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="s-icon"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/prof-dr-faruk-erzengin-676391130/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="s-icon"
                >
